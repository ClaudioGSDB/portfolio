...
const Portfolio = () => {
	...
	const [activeProjectTab, setActiveProjectTab] = useState("Webapp");
	...
	const techSkills: Record<string, string[]> = {
		...
		tools: ["Git", "GitHub", "Docker", "AWS", "Firebase", "VS Code", "Postman"],
	};
	...
	const filteredProjects = projects.filter(
		(project) => project.category === activeProjectTab
	);
